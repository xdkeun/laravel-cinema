		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 p-5 display-4 text-capitalize text-center">
					<h3 class="text-white">무통장 입금 : 아래에 적힌 계좌로 송금해주십시오.</h3>
				</div>
			</div>
				...
				<div class="col-md-5">
					<div class="card border-0">
						...
						<div class="card-body">
								...
								<label for="">입금 계좌번호: 우리 은행 0000-111-2222</label>
								<label for="">구입 후 7일안에 미송금시 결제가 취소됩니다.</label>
								
								<div class="form-group">
							<a href="{{ route('payafter.index') }}">
									<button type="submit" name="payment" class="btn btn-dark btn-block font-weight-bold" onclick="validate()">예매하기</button>
								</div>
