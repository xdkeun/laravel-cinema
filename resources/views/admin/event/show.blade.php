...
?>
        <br>
        <div class="alert mycolor1" role="alert">이벤트</div>
        ...
        <table class="table  table-bordered  table-sm  table-hover mymargin5">
            ...
            <tr>
                <td width="20%" class="mycolor2"><font color="red">*</font>이벤트 제목</td>
                <td width="80%" align="left">{{$row->title}}</td>
            </tr>

            <tr>
                <td width="20%" class="mycolor2"><font color="red">*</font>주최사</td>
                <td width="80%" align="left">{{$row->writer}}</td>
            </tr>

            <tr>
                <td width="20%" class="mycolor2"><font color="red">*</font>이벤트 내용</td>
                <td width="80%" align="left">{{$row->content}}</td>
            </tr>

            <tr>
                <td width="20%" class="mycolor2"><font color="red">*</font>이벤트 기한</td>
        ...
        <div  align="center">
            ...
            <a href="{{ route( 'event.edit', $row->id ) }}{{ $tmp }}" class="btn btn-sm mycolor1">수정</a> &nbsp;

            <form method="post" action="{{ route('event.destroy', $row->id) }}{{ $tmp }}" style="display:inline;">
                @csrf
                @method('DELETE')
