...
<script>
    function find_text()
    {
      form1.action="{{ route('seat.index') }}{{ $tmp }} ";
      form1.submit();
    }
</script>
        ...
        <br>
        <div class="alert mycolor1 ykmargin" role="alert">좌석</div>
            ...
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="text1" value="{{ $text1 }}" class="form-control" 
                    ...
                    <div class="col-9" align="right">
                        <a href="{{ route('seat.create') }}{{ $tmp }}" class="btn btn-sm mycolor1">추가</a>
        ...
        ?>
            <tr>
                ...
                <td><a href="{{ route('seat.show', $row->id) }}{{ $tmp }}">{{$row->seat}}</a></td>
            </tr>
            @endforeach
